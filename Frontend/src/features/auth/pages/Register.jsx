...
export default function Register() {
  ...
  const validate = () => {
    ...
    if(!emailRegex.test(email)) newErrors.email = "Email is not correct"
    if (!username.trim()) newErrors.username = "Username is required";
    if(!phoneRegex.test(phone))  newErrors.phone = "Enter 10 digit correct phone number"
              ...
              <div className="relative">
                ...
                <input
                  ...
                  onChange={(e) => {
                    ...
                    if (errors.emial) setErrors((prev) => ({ ...prev, email: "" }));
                  }}
